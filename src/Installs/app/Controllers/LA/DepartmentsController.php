    ...
    public function dtajax(Request $request)
    {
        ...
        for($i = 0; $i < count($data->data); $i++) {
            ...
            if($this->show_action) {
                ...
                if (Module::hasAccess("Departments", "edit")) {
                    $output .= '<a href="'.url(config('laraadmin.adminRoute') . '/departments/'.$data->data[$i][0].'/edit').'" class="btn btn-warning btn-xs" style="display:inline;padding:2px 5px 3px 5px;width:25px;"><i class="fa fa-edit"></i></a>';
                }
                if (Module::hasAccess("Departments", "delete")) {
                ...
                if (Module::hasAccess("Departments", "delete")) {
                    ...
                    $output .= '                <h4 class="modal-title" id="myModalLabel">Departments delete confirmation</h4>';
                    $output .= '            </div>';
